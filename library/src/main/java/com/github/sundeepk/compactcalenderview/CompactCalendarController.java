...
public class CompactCalendarController {
    ...
    private CompactCalendarView.CompactCalenderViewListener compactCalenderViewListener;
    private int width;
    private int height;
    ...
    void setListener(CompactCalendarView.CompactCalenderViewListener listener){
